                    ...
                    struct xrdp_startup_params *startup_params)
{
    ...
    for (index = 1; index < argc; index ++)
    {
                 ...
                 (g_strncasecmp(argv[index], "--port", 255) == 0))
        {
            ...
            if (argv[index][0] == 0 || g_strlen(argv[index]) >= sizeof(startup_params->port)-1)
            {
                 ...
                 (g_strncasecmp(argv[index], "--config", 255) == 0))
        {
            ...
            if (argv[index][0] == 0 || g_strlen(argv[index]) >= sizeof(startup_params->xrdp_ini_file)-1)
            {
            ...
            g_strncpy(startup_params->xrdp_ini_file, argv[index], sizeof(startup_params->xrdp_ini_file)-1);
