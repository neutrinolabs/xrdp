...
enum SESMAN_CFG_SESS_POLICY
{
    ...
    SESMAN_CFG_SESS_POLICY_UBN = SESMAN_CFG_SESS_POLICY_N,
    ...
    SESMAN_CFG_SESS_POLICY_UBDN = SESMAN_CFG_SESS_POLICY_D | SESMAN_CFG_SESS_POLICY_N
};
