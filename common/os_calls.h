...
int      g_tcp_connect(int *sck, const char *address, const char *port, int (*is_term)(void), int async_to);
int      g_sck_local_connect(int *sck, const char *port, int (*is_term)(void), int async_to);
